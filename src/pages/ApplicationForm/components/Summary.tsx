...
const Summary: React.FC<SummaryProps> = ({ onComplete, onEdit, onBack }) => {
  ...
  const sections = [
    ...
    {
      id: 'employment',
      title: t('summary.sections.employment.title'),
      data: [
    ...
    },
    {
      ...
      data: [
        ...
        { label: t('postEmployment.currentEmployment.isWorking'), value: 'Evet' },
        { label: t('postEmployment.currentEmployment.currentSalary'), value: '$6000' },
      ],
    },
    {
      id: 'evidenceWitness',
